...
export const routesToMenu = (routes: EasyRoute[], recusively: boolean = true, keyPreix: string = "") => {
  if (recusively)
...
const selectedPaths = ( menuRoutes: EasyRoute[]) => {
...
export const EasySimpleLayout: React.FC<{ menuRoutes: EasyRoute[], navRoutes?: EasyRoute[]}> = ({ menuRoutes, navRoutes }) => {
